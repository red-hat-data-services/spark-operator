...
examples/openshift/   # OpenShift deployment examples, Dockerfiles, Makefile, and scripts
...
- `kustomize-e2e.yaml` / `openshift-docling-e2e.yaml` / `scheduledspark-smoke.yaml` - Kustomize/OpenShift e2e tests
