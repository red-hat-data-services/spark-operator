module github.com/opendatahub-io/spark-operator-module
...
require (
	...
	helm.sh/helm/v4 v4.1.4 // indirect; security fix for GHSA-vmx8-mqv2-9gmg, GHSA-q5jf-9vfq-h4h7, GHSA-hr2v-4r36-88hr
